...
silent! normal! zE
let s:l = 91 - ((21 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
91
normal! 048|
lcd ~/git/new-tab-editor
tabedit ~/git/new-tab-editor/manifest.json
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 017|
lcd ~/git/new-tab-editor
tabedit ~/git/new-tab-editor/blank.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 073|
lcd ~/git/new-tab-editor
tabedit ~/git/new-tab-editor/deploy.sh
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 055|
lcd ~/git/new-tab-editor
tabedit ~/git/new-tab-editor/styles.css
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
